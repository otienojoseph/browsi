          ...
          <div className="grid grid-cols-1 items-start gap-y-12 md:grid-cols-3 md:gap-x-8 md:gap-y-16 lg:gap-x-12">
            <div>
              ...
              <p className="mb-5 md:mb-6">
                We specialize in creating custom websites that engage and
                convert visitors.
              </p>
            ...
            <div>
              ...
              <p className="mb-5 md:mb-6">
                Our responsive designs ensure a seamless user experience across
                all platforms.
              </p>
              <div className="mt-6 flex flex-wrap items-center gap-4 md:mt-8">
                <Button
            ...
            <div>
              ...
              <p className="mb-5 md:mb-6">
                We provide tailored e-commerce solutions that drive sales and
